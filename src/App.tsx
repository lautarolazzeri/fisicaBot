      ...
      <aside className="w-80 border-r border-zinc-800 bg-zinc-900/30  flex-col hidden lg:flex shrink-0">
        <div className="p-6 border-b border-zinc-800">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-linear-to-br from-blue-600 to-indigo-600 flex items-center justify-center shadow-lg shadow-blue-900/20">
              <Atom className="w-6 h-6 text-white" />
            </div>
            <div>
              <h1 className="text-lg font-bold tracking-tight">
                Fisica <span className="text-blue-500">Bot</span>
              </h1>
